...
\textbf{Respuesta: }
\\
\textbf{Polimorfismo Explicito: }
\\
\textbf{Desventajas: } 
\\Poca legibilidad de código debido al hecho de poder tener diversas funciones con el mismo nombre.
\\
\textbf{Ventajas: }
\\Permitir el reciclamiento de código
\\
\textbf{Polimorfismo Implicito: }
